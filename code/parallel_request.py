...
os.environ["OPENAI_API_KEY"] = "sk-iuqseKzMcVkidgfIIvwfkA"
@app.command()
def cli(
    ...
    model: Annotated[str, typer.Option(help="the LLM/Embedding model to be called")] = "gpt-4o",
    base_url: Annotated[str, typer.Option(help="URL of the API endpoint to call")] = "http://18.216.253.243:4000",
