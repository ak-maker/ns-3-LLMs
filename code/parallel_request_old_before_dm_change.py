...
os.environ["OPENAI_API_KEY"] = "sk-7K6RYF1OWEaUz3jzKSuUVA"
# os.environ["OPENAI_API_KEY"] = "sk-wdCbYUnFVclwbzmMPy4CKQ"
@app.command()
def cli(
    ...
    base_url: Annotated[str, typer.Option(help="URL of the API endpoint to call")] = "http://3.133.138.97:4000/",
